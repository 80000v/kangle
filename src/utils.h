...
#define CRYPT_TYPE_HTPASSWD 3
#define TOTAL_CRYPT_TYPE	4
#else
#define TOTAL_CRYPT_TYPE    3
#endif
...
#ifdef WORK_MODEL_PORTMAP
	} else if (strcasecmp(type,"portmap")==0) {
		SET(model,WORK_MODEL_PORTMAP);
#endif
